        ...
        <nav className="bg-white shadow-md">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between items-center h-16">
                    {/* Logo/Brand */}
                    <div className="flex-shrink-0 cursor-pointer flex items-center" onClick={() => navigate('list')}>
                        ...
                        {user ? (
                            <div className="relative" ref={dropdownRef}>
                                <button
                                    ...
                                    className="flex items-center space-x-3 text-slate-700 hover:text-slate-900 focus:outline-none"
                                >
                                    <img
