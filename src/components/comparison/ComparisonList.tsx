...
const ComparisonList: React.FC<ComparisonListProps> = ({ onCreate, onView }) => {
    ...
    if (isError) {
        return <div className="text-center py-10 text-red-500">Error: {(error as Error).message}</div>;
    }

    const comparisons: Template[] = data?.templates || [];
