...
const ComparisonHeader: React.FC<ComparisonHeaderProps> = ({ comparison }) => {
    return (
        <div className="bg-white dark:bg-slate-800 rounded-lg shadow-xl overflow-hidden mb-8 transition-colors dark:border dark:border-slate-700">
            <img 
                src={comparison.imageUrl || 'https://placehold.co/1200x400/a5b4fc/ffffff?text=Comparison'} 
                ...
                <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                    <div>
                        ...
                        <div className="flex items-center gap-6 mt-4 text-slate-500 dark:text-slate-400 text-base">
                            <FavoriteButton 
                                templateId={(comparison.id || comparison.templateId) as string} 
