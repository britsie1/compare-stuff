...
const TemplateFieldsEditor: React.FC<TemplateFieldsEditorProps> = ({
  fields,
  setFields,
  minFields = 1,
  showLabel = true,
  ...
  const handleFieldTypeChange = (index: number, fieldType: TemplateField['fieldType']) => {
    const newFields = [...fields];
                      ...
                      {field.type === 'section' ? (
                        ...
                        <>
                          ...
                          <div className="flex-shrink-0 w-28">
                            <FieldTypeSelector value={field.fieldType} onChange={(e) => handleFieldTypeChange(index, e.target.value as TemplateField['fieldType'])} />
                          </div>
                        </>
                      )}
