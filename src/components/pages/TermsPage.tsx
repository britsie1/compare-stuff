...
const TermsPage: React.FC<TermsPageProps> = ({ onBack }) => (
    <div className="max-w-4xl mx-auto bg-white dark:bg-slate-800 p-4 md:rounded-lg md:p-8 md:shadow-xl transition-colors">
        ...
        <div className="prose dark:prose-invert max-w-none text-slate-700 dark:text-slate-300">
            ...
            <p>CompareStuff is a platform for comparing products, services, and concepts. It is not a platform for judging or comparing individuals. To ensure a safe and respectful environment, you agree not to create, share, or engage with any content that:</p>
            <ul>
            ...
            <p>You are solely responsible for the content you create. While we encourage factual and helpful comparisons, CompareStuff does not guarantee the accuracy, integrity, or quality of user-generated content. Use the information on this platform at your own risk.</p>
